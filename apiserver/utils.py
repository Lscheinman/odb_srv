"""
Provide basic data cleansing and otherwise common functions that can be used by any blueprint model or view including
custom files. Also manage the naming of all sensitive variables from the config file to provide blueprints abstracted
values.
"""
...
from apiserver.config import HOST_IP, SECRET_KEY, MAIL_PASSWORD,\
    MAIL_USERNAME, HTTPS, TWITTER_AUTH, SHODAN, MESSAGE_OPENING, \
    MESSAGE_CLOSING, ODB_USER, ODB_PSWD
